 ...
 * data 2017-10-18
 */
myApp.directive("citySelected", function() {
    return {
        restrict: 'A',
        scope: {
            ngModel: '='
        ...
        link: function(scope, elem, attrs) {
            ...
            var datas = [{
                    name: '北京',
                    cityList: [{ name: '市辖区', areaList: ['东城区', '西城区', '崇文区', '宣武区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '怀柔区', '平谷区'] },
            ...
            /**
             * [检测详细地址的改变]
             * @param  {Object} newValue) [改变过的详细地址]
             * @return {[type]}           [返回省市区详细地址数据]
             */
            scope.$watch('detailAddress', function(newValue) {
                scope.ngModel = {
                    "province": scope.country == null || scope.country == '' ? '' : scope.country.name,
                    "city": scope.province == null || scope.province == '' ? '' : scope.province.name,
                    "area": scope.city || '',
